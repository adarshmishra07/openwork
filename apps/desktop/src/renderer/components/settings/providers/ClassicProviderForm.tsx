...
import type { ProviderId, ConnectedProvider, ApiKeyCredentials } from '@shopos/shared';
import { PROVIDER_META, DEFAULT_PROVIDERS, getDefaultModelForProvider } from '@shopos/shared';
import {
  ModelSelector,
  ConnectButton,
  ConnectedControls,
