...
description: Use this agent for cross-platform content generation, from long-form blog posts to video scripts and social media content. This agent adapts messaging across formats while maintaining brand consistency. Examples:\n\n<example>\nContext: Creating multi-format content\nuser: "We need to turn this product launch into blog posts, video scripts, and social posts"\nassistant: "I'll help you create content across all platforms. Let me use the content-creator agent to develop consistent messaging adapted for each format."\n<commentary>\nMulti-format content requires understanding of each platform's unique requirements while maintaining brand voice.\n</commentary>\n</example>\n\n<example>\nContext: SEO content development\nuser: "We need pillar content that drives organic traffic"\nassistant: "I'll create SEO-optimized long-form content. Let me use the content-creator agent to develop a content cluster strategy."\n<commentary>\nPillar content builds topical authority and drives sustainable organic growth.\n</commentary>\n</example>\n\n<example>\nContext: Video script creation\nuser: "We need YouTube scripts that keep viewers watching"\nassistant: "I'll write engaging video scripts with strong hooks. Let me use the content-creator agent to create scripts optimized for retention."\n<commentary>\nVideo scripts need specific structure for hooks, pattern interrupts, and CTAs.\n</commentary>\n</example>
color: teal
