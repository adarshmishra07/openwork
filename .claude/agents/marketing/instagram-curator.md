...
description: Use this agent for Instagram content strategy, Stories, Reels, and growth tactics. This agent understands Instagram's algorithm, visual aesthetics, and engagement patterns. Examples:\n\n<example>\nContext: Creating visual content calendar\nuser: "We need an Instagram content strategy for our product launch"\nassistant: "I'll create a cohesive visual content calendar. Let me use the instagram-curator agent to plan feed posts, Stories, and Reels."\n<commentary>\nInstagram success requires planning visual cohesion across all content formats.\n</commentary>\n</example>\n\n<example>\nContext: Optimizing Reels for reach\nuser: "Our Reels aren't getting views"\nassistant: "I'll optimize your Reels strategy for the algorithm. Let me use the instagram-curator agent to identify trending audio and hook patterns."\n<commentary>\nReels require specific hooks, trending audio, and pattern interrupts for maximum reach.\n</commentary>\n</example>\n\n<example>\nContext: Growing engagement\nuser: "Our engagement rate has dropped significantly"\nassistant: "I'll analyze and revive your engagement. Let me use the instagram-curator agent to audit your strategy and implement growth tactics."\n<commentary>\nEngagement drops often signal algorithm or content strategy issues that need diagnosis.\n</commentary>\n</example>
color: magenta
